...
function Login({login, user, register}) {
    ...
    return isLogin ? (<section className="w-full px-2 py-20 bg-gray-100 xl:px-8 flex-grow dark:bg-gray-700">
                ...
                <div className="w-full mt-16 md:mt-0 md:w-2/5">
                    <div className="relative z-10 h-auto p-8 py-10 overflow-hidden bg-white dark:bg-gray-800 border-b-2 border-gray-300 dark:border-gray-900 rounded-lg shadow-2xl px-7">
                        <form onSubmit={onSubmit}>
                            <h3 className="mb-6 text-2xl font-medium text-center dark:text-gray-300">Sign in to your Account</h3>
    ...
    </section>) : (<div className="py-20 bg-white dark:bg-gray-700 container max-w-6xl mx-auto grid justify-center px-2"> 
            <form className="w-full max-w-lg bg-white dark:bg-gray-800 border-b-2 border-gray-300 dark:border-gray-900 rounded-lg shadow-2xl p-8 py-10" onSubmit={onSubmit}>
                <div className="flex flex-wrap -mx-3 mb-6">
                    <div className="w-full px-3">
                        <h3 className="mb-6 text-2xl font-medium text-center dark:text-gray-300">Sign Up</h3>
                    </div>
                </div>
                <div className="flex flex-wrap -mx-3 mb-6">
                ...
                <div className="flex flex-wrap -mx-3 mb-6">
                    <div className="w-full px-3">
                        <label className="block uppercase tracking-wide text-gray-500 text-xs font-bold mb-2" htmlFor="emailInput">
                        Email
                        </label>
                        <input required name="email" className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="emailInput" type="email"/>
                    </div>
                </div>
                <div className="flex flex-wrap -mx-3 mb-6">
                    <div className="w-full px-3">
                        <label className="block uppercase tracking-wide text-gray-500 text-xs font-bold mb-2" htmlFor="phoneInput">
                        Phone Number
                        </label>
                        <input required name="phoneNumber" className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="phoneInput" type="phone"/>
                    </div>
                </div>
                <div className="flex flex-wrap -mx-3 mb-6">
                    <div className="w-full px-3">
                        <label className="block uppercase tracking-wide text-gray-500 text-xs font-bold mb-2" htmlFor="grid-password">
                            Password
                        </label>
                        <input 
                ...
                <div className="flex flex-wrap -mx-3 mb-2">
                    <div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-6 md:mb-0">
                        <label className="block uppercase tracking-wide text-gray-500 text-xs font-bold mb-2" htmlFor="street">
                        Street
                        </label>
                        <input 
                ...
                <div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-6 md:mb-0">
                    ...
                    <input required name="state" className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state" type="text"/>
                </div>
                <div className="w-full md:w-1/2 lg:w-1/4 px-3 mb-6 md:mb-0">
                    <label className="block uppercase tracking-wide text-gray-500 text-xs font-bold mb-2" htmlFor="grid-zip">
                    Zip
                    </label>
...
export default connect(s=>({user:s.user}), {login, register})(Login)
